...
(function(undefined) {
    ...
    var Random = function() {
        ...
        Random.extend({
            areas: [ "娑撴粌瀵�", "閸楀骸瀵�", "閸楀簼绗�", "閸楀簼鑵�", "閸楀骸宕�", "鐟楀灝宕�", "鐟楀灝瀵�" ],
            area: function() {
                return this.pick(this.areas);
            },
            regions: [ "110000 閸栨ぞ鍚敮锟�", "120000 婢垛晜瑙︾敮锟�", "130000 濞屽啿瀵抽惇锟�", "140000 鐏炶精銈块惇锟�", "150000 閸愬懓鎸嬮崣銈堝殰濞岃灏�", "210000 鏉堣棄鐣為惇锟�", "220000 閸氬鐏勯惇锟�", "230000 姒涙垿绶冲Ч鐔烘阜", "310000 娑撳﹥鎹ｇ敮锟�", "320000 濮圭喕瀚冮惇锟�", "330000 濞存瑦鐫欓惇锟�", "340000 鐎瑰绐橀惇锟�", "350000 缁傚繐缂撻惇锟�", "360000 濮圭喕銈块惇锟�", "370000 鐏炲彉绗㈤惇锟�", "410000 濞屽啿宕￠惇锟�", "420000 濠€鏍у閻拷", "430000 濠€鏍у础閻拷", "440000 楠炲じ绗㈤惇锟�", "450000 楠炶儻銈挎竟顔芥閼奉亝涓嶉崠锟�", "460000 濞村嘲宕￠惇锟�", "500000 闁插秴绨＄敮锟�", "510000 閸ユ稑绐涢惇锟�", "520000 鐠愰潧绐為惇锟�", "530000 娴滄垵宕￠惇锟�", "540000 鐟楄儻妫岄懛顏呬笉閸栵拷", "610000 闂勬洝銈块惇锟�", "620000 閻㈡ǹ鍊戦惇锟�", "630000 闂堟帗鎹ｉ惇锟�", "640000 鐎逛礁顦撮崶鐐存閼奉亝涓嶉崠锟�", "650000 閺傛壆鏋傜紒鏉戞儱鐏忔棁鍤滃▽璇插隘", "650000 閺傛壆鏋傜紒鏉戞儱鐏忔棁鍤滃▽璇插隘", "710000 閸欑増鍜曢惇锟�", "810000 妫ｆ瑦鑵愰悧鐟板焼鐞涘本鏂傞崠锟�", "820000 濠㈡娊妫悧鐟板焼鐞涘本鏂傞崠锟�" ],
            region: function() {
